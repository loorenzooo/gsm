...
<html>
<head>
<title>Antique ceramic vase - Galerie Saint Martin - French antique vases</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="description" content="Dealer of antique ceramic vases in a fine art gallery in Paris, to sell XIXth to early XXst paintings, furniture and objects of art XVIIth to early XXst, antique french vases.">
<meta name="keywords" content="Antique ceramic vase, french antique cases, antique ceramic vases, french antique vase">
    ...
    <td height="100%" valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="100%" align="center" valign="top"><table width="90%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><span class="soustitre"><strong><font size="3"></font></strong></span>              <H1><span class="soustitre"><strong>Antique Ceramic Vase</strong></span></H1></td>
          </tr>
          <tr>
          ...
          <table width="90%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>    <H2><span class="soustitre"><strong><span class="Style2">Antique French Vase</span></strong></span></H2> </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              <td align="center"><span class="rouge"><img src="charte/puce.gif" width="5" height="7"><strong class="titre"> <span class="Style3">Examples of</span> <a href="http://www.galeriesaintmartin.com/rubrique.php?type=3&langue=en">antique ceramic vases</a></strong></span></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td align="center"><img src="images/oeuvres/vase.jpg" alt="Antique ceramic vase" width="250" height="318"></td>
              </tr>
            <tr>
              <td align="center"><font face="Arial" class="titre"><a href="http://www.galeriesaintmartin.com/en_presentation.php">French antique vases</a> <span class="Style3">in our shop in Paris</span> </font></td>
              </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              <td class="titre"><div align="center">Galerie Saint Martin is an antique dealer and fine art gallery in Paris selling XIXth to early XXst paintings, furniture and objects of art XVIIth to early XXst, antique country furniture and fine pieces of furniture. </div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
...
<p> 
      ...
      <i><a href="http://www.galeriesaintmartin.com/rubrique.php`??o?????????ü???????????????????????????????????†††††????††††††???†††††††?????????†††††????††††††???†††††††??????????????????????????•????????????=?????????????????††††††????††††††???†††††††??????????????????•??????????????????????????????????????????????????? ??Z??????g ?t???????††††††?????????????????††††????°?????????†††??†??†?†????????????????††É??O????††††????????†††????†††????a??}????O?????????††††???††††??????(???????????????????????????type=1&langue=en">French impressionist painting</a></i>
