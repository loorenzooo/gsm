...
if(isset($_GET['type'])) $idType = $_GET['type'];
    ...
    <td height="100%" valign="top" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<table width="90%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><span class="legende"><a href="produit.php?idGenre=<?= $idGenre;?>&type=<?= $idType;?>&langue=<?= $_SESSION['langue']?>"><?= $dic['retour'];?></a></span></td>
          </tr>
        </table>
		<br>
		    ...
		    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <tr align="center">
                <td>
                 ...
                 <td><a href="#" onclick="window.open('popup.php?img=<?= $repertoire_oeuvre.$res['img2_oeuvre']; ?>','pop1','scrollbars=no,statusbar=no,resizable=no, menubar=no'); return false;"> <img src="<?= $repertoire_oeuvre_mini.$res['img2_oeuvre']; ?>" width="150" border="0"></a><br>
                   <a href="#" onclick="window.open('popup.php?img=<?= $repertoire_oeuvre.$res['img2_oeuvre']; ?>','pop1','scrollbars=no,statusbar=no,resizable=no, menubar=no'); return false;"><?= $dic['agrandir']?></a></td>
                  <?php }?>
