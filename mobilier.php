...
<html>
<head>
<title>Mobilier de style Louis XIII, Louis XIV, Louis XV, R&eacute;gence, Louis XVI, Empire ou Restauration</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="description" content="Galerie d'antiquit&eacute;s et d'art proposant &agrave; la vente du mobilier de style Louis XIII, Louis XIV, Louis XV, R&eacute;gence, Louis XVI, Directoire, Consulat, Empire ou Restauration.">
<meta name="keywords" content="Mobilier Louis XIII, mobilier Louis XIV, Mobilier Louis XV, mobilier R&eacute;gence, Mobilier Louis XVI, mobilier Directoire, Mobilier Consulat, mobilier Empire, Mobilier Restauration">
        ...
        <td height="100%" align="center" valign="top"><table width="90%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                <td><span class="soustitre"><strong><font size="3"></font></strong></span> 
                  <H1><span class="soustitre"><strong><font size="3">Mobilier 
                    Louis XIII, Louis XIV, Louis XV ou Louis XVI ... </font></strong></span></H1></td>
          </tr>
          <tr>
          ...
          <table width="90%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <tr> 
                <td colspan="2"><span class="titre">
                  <H2><font size="2">Mobilier de style R&eacute;gence, Directoire, 
            ...
            <tr align="center">
              <td colspan="2"><span class="rouge"><img src="charte/puce.gif" width="5" height="7"> Types de <a href="http://www.galeriesaintmartin.com/rubrique.php?type=2">mobilier</a> disponibles: </span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="45%" align="center"><img src="images/oeuvres/commode2.jpg" width="200" height="149"></td>
              <td width="45%" align="center"><img src="images/oeuvres/console2.jpg" width="161" height="150"></td>
            </tr>
            <tr>
                <td align="center"> <font face="Arial"><a href="http://www.galeriesaintmartin.com">Mobiliers anciens</a></font></td>
                <td width="45%" align="center"><a href="http://www.galeriesaintmartin.com/rubrique.php?type=2">Mobilier 
                  de style</a></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            ...
            <tr>
                <td colspan="2"><span class="titre">Galerie d'antiquit&eacute;s 
                  sp&eacute;cialis&eacute; dans le mobilier de style Louis XIV, 
                  R&eacute;gence, Louis XV, Louis XVI, Consultat, Directoire, 
                  Empire ou Restauration.</span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr align="left">
                <td colspan="2"><span class="titre">La Galerie Saint Martin propose 
                  &eacute;galment &agrave; la vente des objets d'art, des antiquit&eacute;s, 
                  des tableaux et des meubles de type r&eacute;gional.</span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
