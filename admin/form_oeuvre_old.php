<?php
	...
	else
	{
		...
		//fin du traitement des images
			...
			//si il n'y a pas de genre à selectionner : curiosité + exposition on attribut par défaut un genre
...
<div class="soustitre" align="center">Ajout d'une oeuvre </div> 
...
?>
  <table width="88%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr> 
      ...
      <td colspan="3"> 
		...
		<select name="artiste" id="artiste">
          <?php
		  $sql = "SELECT * FROM artiste ORDER BY nom_artiste, prenom_artiste ASC";
	...
	//affichage du genre seulement si il ne s'agit pas d'exposition "4" et de curiosité "5"
    ...
    <tr>
      ...
      <td>
	  <!-- affichage de la liste des genre par rapport à un type $type précédemment selectionner -->
	...
	<?php
	  ...
	  //affichage du champ nom seulement si il ne s'agit pas d'exposition "4" et de curiosité "5"
	  if($type!=4 AND $type!=5)
	  {
	  ?>
	  <tr> 
	...
	<tr> 
      ...
      <td colspan="3"><input name="image2" type="file" id="image2"></td>
    </tr>
    <tr> 
