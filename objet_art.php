		    ...
		    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
              <tr align="center"> 
				...
				<?php if(file_exists($repertoire_oeuvre.$res['img2_oeuvre']) AND $res['img2_oeuvre']!="") {?>
                  <td width="50%"><a href="#" onclick="window.open('popup.php?img=<?= $repertoire_oeuvre.$res['img2_oeuvre']; ?>','pop1','scrollbars=no,statusbar=no,resize=no,menubar=no'); return false;"> <img src="<?= $repertoire_oeuvre_mini.$res['img2_oeuvre']; ?>" border="0"></a><br>
                    <span class="legende">
                    <?= $res[$img_prefix.'legende2_oeuvre'] ?>
                  </span><a href="#" onclick="window.open('popup.php?img=<?= $repertoire_oeuvre.$res['img2_oeuvre']; ?>','pop1','scrollbars=no,statusbar=no,resize=no,menubar=no'); return false;"><?= $dic['agrandir']?></a></td>
                  <?php }?>
              ...
              <tr align="center"> 
                <td colspan="2"><a href="artiste.php?idArtiste=<?= $res['id_artiste']?>&langue=<?= $_SESSION['langue']?>"> 
              ...
              <tr align="center"> 
                <td colspan="2" class="legende"> 
                  <div align="justify"> <?= nl2br($res[$img_prefix.'desc_oeuvre']) ?></div></td>
              </tr>
              <tr align="center"> 
                <td colspan="2">&nbsp;</td>
              </tr>
