...
<html>
<head>
<title>Meubles de style Louis XIII, Louis XIV, Louis XV, R&eacute;gence, Louis XVI, Empire ou Restauration</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="description" content="Galerie d'antiquit&eacute;s et d'art de Paris proposant &agrave; la vente des meubles de style Louis XIII, Louis XIV, Louis XV, R&eacute;gence, Louis XVI, Directoire, Consulat, Empire ou Restauration.">
<meta name="keywords" content="Meubles Louis XIII, meubles Louis XIV, Meubles Louis XV, meubles R&eacute;gence, Meubles Louis XVI, meubles Directoire, Meubles Consulat, meubles Empire, Meubles Restauration">
        ...
        <td height="100%" align="center" valign="top"><table width="90%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                <td><span class="soustitre"><strong><font size="3"></font></strong></span> 
                  <H1><span class="soustitre"><strong><font size="3">Meubles Louis 
                    XIII, Louis XIV, Louis XV et Louis XVI</font></strong></span></H1></td>
          </tr>
          <tr>
          ...
          <table width="90%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <tr> 
                <td colspan="2"><span class="titre">
                  <H2><font size="2">Meubles de style R&eacute;gence, Directoire, 
                    Consulat, Empire et Restauration</font></H2>
                  </span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            ...
            <tr align="center">
                <td colspan="2"><span class="rouge"><img src="charte/puce.gif" width="5" height="7"> 
                  Types de <a href="http://www.galeriesaintmartin.com/rubrique.php?type=2">meubles 
            ...
            <tr>
              <td width="45%" align="center"><img src="images/oeuvres/meuble.jpg" width="165" height="300"></td>
              <td width="45%" align="center"><img src="images/oeuvres/meuble2.jpg" width="151" height="300"></td>
            </tr>
            <tr>
                <td align="center"> <font face="Arial"><a href="http://www.galeriesaintmartin.com"></a>Meubles 
                  anciens</font> de style </td>
                <td width="45%" align="center"><font face="Arial"><a href="http://www.galeriesaintmartin.com/rubrique.php?type=2">Meubles 
                  de styles ancien</a>s </font></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            ...
            <tr>
                <td colspan="2"><span class="titre">Nos magasins proposent &agrave; 
                  la vente du mobilier de diff&eacute;rents &eacute;poques et 
                  de styles divers : Louis XIV, R&eacute;gence, Louis XV, Louis 
                  XVI, Consultat, Directoire, Empire ou Restauration.</span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr align="left">
                <td colspan="2"><span class="titre">Galerie d'art et d'antiquit&eacute;s 
                  de Paris et de Bretenoux (Lot), la galerie Saint Martin proposant 
                  une large palette de mobilier r&eacute;gional ancien.</span></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
